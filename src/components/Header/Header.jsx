...
import { HeaderContainer, Logo, MenuWrapper, ButtonMenu, ButtonGetInTouch } from './Header.styled';
		...
		<HeaderContainer $isScrolling={isScrolling}>
			<Logo href="/ecosolution">
				...
				<Icon
					...
					fill={'inherit'}
				/>
				<Icon iconName="icon-greenergy" width={'60px'} height={'18px'} fill={'inherit'} />
			</Logo>

			<MenuWrapper>
				<ButtonMenu type="button" onClick={handleToggleMenu}>
					<Icon iconName="icon-menu" width={'16px'} height={'16px'} stroke={'#000'} />
				</ButtonMenu>
